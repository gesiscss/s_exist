...
if __name__ == '__main__':
    ...
    for name, classifier, params in zip(names, classifiers, parameters):
        ...
        gs_clf = GridSearchCV(clf, param_grid=params, n_jobs=-1, cv = 10)
        ...
        # save the classifier
        with open(MODELPATH + '/exist2021_%s.pkl' %(name), 'wb') as fid:
        ...
        all_results.append(get_results(cr, y, y_pred, method = name, hyperparams = gs_clf.best_params_))
        ...
        try:
            ...
            generate_test_run(test, task = "task1", run = "2", model_type = name)
    ...
    print(result_df)  
    result_df.to_csv("finetuned_classification_result_summary.csv", index = False, sep = "\t")    
